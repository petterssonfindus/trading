...
/**
 * Multipliziert 2 bestehende Indikatoren Berücksichtigt einen zusätzlichen
 * festen Faktor (Multiplikator) Jeder Indikator kann als Nenner verwendet
 * werden durch reziproken Wert parameter: reziprok1 (optional) - Integer 0 oder
 * null = Zähler 1 = Nenner reziprok2 (optional) - Integer 0 oder null = Zähler
 * 1 = Nenner faktor dient als Multiplikator
 * 
 * @author oskar
 */
@Entity(name = "Multiplikation")
@DiscriminatorValue("Multiplikation")
