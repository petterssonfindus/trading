...
@Entity(name = "MoneyFlowMultiplier")
@DiscriminatorValue("MoneyFlowMultiplier")
public class IndikatorMFM extends IndikatorAlgorithmus {

	/**
	 * Money Flow Multiplier = [(Close - Low) - (High - Close)] /(High - Low) Ist
	 * positiv, wenn Schlusskurs nahe Tages-high - ist negativ wenn Schlusskurs nahe
	 * Tages-low.
