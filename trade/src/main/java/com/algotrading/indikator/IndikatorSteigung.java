 ...
 * unabhängig von der Dauer eine positive Dauer geht bei der Auswahl des
 * eingesetzten Kapitals rückwärts und berechnet die Steigung in der
 * abgelaufenen Zeit eine negative Dauer geht vorwärts für die kommende Zeit
 * 
 * @author oskar
 *
 */
@Entity(name = "Steigung")
@DiscriminatorValue("Steigung")
public class IndikatorSteigung extends IndikatorAlgorithmus {
	...
	private void rechneSteigung(Aktie aktie, int dauer, float kapitalBeginn, float kapitalEnde, int i) {
		float steigung;
